...
CSV_PATH = os.path.join(ROOT, 'data', 'keypoint.csv')
DATA_IMAGES = os.path.join(ROOT, 'assets', 'data')
...
# For static images under assets/data/<LETTER_OR_DIGIT>/<index>.jpg
IMAGE_FILES = []
for i in alphabet:
  for j in range(1199):
    IMAGE_FILES.append(os.path.join(DATA_IMAGES, i, f'{j}.jpg'))
with mp_hands.Hands(
